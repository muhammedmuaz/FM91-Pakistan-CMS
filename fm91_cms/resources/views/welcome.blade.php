            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="Table bootstrap datatable footable" class="nav-item">
                        <a href="schedule.php" class="nav-link "><span class="pcoded-micon"><i class="fa fa-calendar"></i></span><span class="pcoded-mtext">schedule</span></a>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="playlist.php" class="">Playlist Title</a></li>
                            <li class=""><a href="playlist-add.php" class="">Playlists</a></li>
                        </ul>
                    </li>
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="podcast-main.php" class="">Podcast Titles</a></li>
                            <li class=""><a href="podcast-inside.php" class="">Podcast Show</a></li>
                            <li class=""><a href="podcast.php" class="">Podcasts</a></li>
                    ...
                    <li data-username="Table bootstrap datatable footable" class="nav-item">
                        <a href="users.php" class="nav-link "><span class="pcoded-micon"><i class="fa fa-users"></i></span><span class="pcoded-mtext">users</span></a>
                    </li>
